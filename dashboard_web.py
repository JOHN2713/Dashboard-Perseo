...
st.set_page_config(
    page_title="Dashboard Perseo WEB | Perseo",
    page_icon="🌐",
    layout="wide",
...
columnas_importantes = [
    ...
    'Meses Vigencia', 'Moviles', 'Provincia'
]
...
if columnas_seleccionadas:
    ...
    st.download_button(
        ...
        data=csv,
        file_name=f'perseo_web_filtrado_{datetime.now().strftime("%Y%m%d")}.csv',
        mime='text/csv'
    )
else:
...
<div style='text-align: center; padding: 2rem 0;'>
    ...
    <p style='color: gray; margin: 0;'>Dashboard Perseo WEB - Análisis de Clientes y Suscripciones</p>
